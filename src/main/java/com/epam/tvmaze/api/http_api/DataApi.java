...
public class DataApi{
    ...
    public final String CORRECT_EPISODE = "shows/1/episodebynumber?season=1&number=1";
    public final String INCORRECT_EPISODE = "1/episodebynumber?season=1&number=0";
}
